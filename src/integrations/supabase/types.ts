  ...
  public: {
    Tables: {
      ...
      notifications: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["pickup_id"]
            isOneToOne: false
            referencedRelation: "pickups_with_distance"
            referencedColumns: ["id"]
          },
          {
      ...
      pickups: {
        Row: {
          ...
          updated_at: string | null
          weight_category: Database["public"]["Enums"]["weight_category"] | null
        }
        Insert: {
          actual_weight?: number | null
          address: string
          ...
          updated_at?: string | null
          weight_category?:
            | Database["public"]["Enums"]["weight_category"]
            | null
        }
        Update: {
          actual_weight?: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "pickups_assigned_to_fkey"
            columns: ["assigned_to"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscriptions_collector_id_fkey"
    ...
    Functions: {
      ...
      update_pickup_status: {
        Args: {
          pickup_id: string
          new_status: Database["public"]["Enums"]["pickup_status"]
          collector_id?: string
        }
        Returns: boolean
      }
    ...
    Enums: {
      ...
      payment_method: "tunai" | "transfer" | "e_wallet"
      pickup_status: "pending" | "taken" | "completed" | "cancelled"
      subscription_payment_status: "pending" | "success" | "failed" | "refunded"
      subscription_tier: "free" | "medium" | "large"
      user_role: "customer" | "collector"
      weight_category: "ringan" | "sedang" | "berat" | "sangat_berat"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
